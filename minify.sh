...
uglifyjs  --compress --mangle --output dist/mi5-component.min.js dist/mi5-component.js
...
uglifyjs  --compress --mangle --output dist/ichigo-full.min.js dist/ichigo-full.js